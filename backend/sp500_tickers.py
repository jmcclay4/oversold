# sp500_tickers.py
# List of S&P 500 tickers as of June 2025 (approximated based on common constituents)
SP500_TICKERS = [
    ...
    "CDNS", "CDW", "CE", "CF", "CFG", "CHRW", "CHTR", "CI", "CINF", "CL",
    "CLX", "CMA", "CMCSA", "CME", "CMG", "CMI", "CMS", "CNC", "CNP", "COF",
    "COO", "COP", "COST", "CPB", "CPRT", "CRL", "CRM", "CSCO", "CSGP", "CSX",
    "CTAS", "CTLT", "CTRA", "CTSH", "CVS", "CVX", "CZR", "D", "DAL", "DAY",
    "DD", "DE", "DFS", "DG", "DGX", "DHI", "DHR", "DIS", "DLR", "DLTR", "DOV",
    "DOW", "DPZ", "DRI", "DTE", "DUK", "DVA", "DXCM", "EA", "EBAY", "ECL",
    ...
    "FI", "FIS", "FITB", "FMC", "FOX", "FOXA", "FRT", "FSLR", "FTNT", "FTV",
    "GD", "GE", "GEHC", "GEN", "GILD", "GIS", "GL", "GLW", "GM", "GNRC", "GOOG",
    ...
    "ORCL", "ORLY", "OTIS", "OXY", "PAYC", "PAYX", "PCAR", "PCG", "PEG", "PEP",
    "PFE", "PFG", "PG", "PGR", "PH", "PHM", "PKG", "PLD", "PM", "PNC", "PNR",
    "PNW", "PODD", "POOL", "PPG", "PPL", "PRU", "PSX", "PTC", "PWR", "PXD",
    ...
    "TT", "TTWO", "TXN", "TXT", "TYL", "UAL", "UDR", "ULTA", "UNH", "UNP",
